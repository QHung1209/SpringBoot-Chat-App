...
public interface ConversationMemberRepository extends JpaRepository<ConversationMember, UUID> {
        ...
        Optional<ConversationMember> findByConversationIdAndUserId(UUID conversationId,
                        UUID userId);
        ...
        @Query(value = """
                        ...
                        """,
                        nativeQuery = true)
        List<MemberProfileProjection> findAllByConversationIdOrderByCreatedAtAsc(
                        UUID conversationId, Instant createdAt);
